...
!(function (e, t) {
    ...
    E.ajaxSetup({
        ...
        E.each(
            "blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextG-nav-menu".split(
                " "
            ),
            function (e, n) {
                E.fn[n] = function (e, t) {
